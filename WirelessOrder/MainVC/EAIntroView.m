...
//    self.pageControl = [[UIPageControl alloc] initWithFrame:CGRectMake(0, self.frame.size.height - self.pageControlY, self.frame.size.width, 20)];
    ...
    self.pageControl.pageIndicatorTintColor=kUIColorFromRGB(0xe3e3e3);
    self.pageControl.currentPageIndicatorTintColor=kUIColorFromRGB(0xffb5c1);
...
//    self.skipButton = [[UIButton alloc] initWithFrame:CGRectMake(self.scrollView.frame.size.width - 80, self.pageControl.frame.origin.y, 80, self.pageControl.frame.size.height)];
    self.skipButton=[[UIButton alloc] initWithFrame:CGRectMake((ScreenWidth-80)/2, self.pageControl.frame.origin.y+25, 80, self.pageControl.frame.size.height)];
    ...
    [self.skipButton setTitleColor:kUIColorFromRGB(0xb3b3b3) forState:UIControlStateNormal];
